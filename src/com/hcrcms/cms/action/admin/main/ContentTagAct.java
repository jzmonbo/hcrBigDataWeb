...
public class ContentTagAct {
	...
	@RequestMapping("/tag/v_add.so")
	public String add(ModelMap model) {
		return "tag/add";
	}

	@RequiresPermissions("tag:v_edit")
	@RequestMapping("/tag/v_edit.so")
	...
	@RequestMapping("/tag/v_ajax_edit.so")
	...
	@RequestMapping("/tag/o_update.so")
	...
	@RequestMapping("/tag/o_delete.so")
