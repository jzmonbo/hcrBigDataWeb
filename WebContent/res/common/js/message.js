...
function forward(){
	$("#jvForm").attr("action","v_forward.so");
	$("#jvForm").submit();
}
function empty(){
	var ids=new Array();
...
function toDraft(){
	$("#box").val(2);
	$("#nextUrl").val("v_list.so?box=2");
	$("#jvForm").attr("action","v_save.so");
	$("#jvForm").submit();
}
function toSend(){
	$("#nextUrl").val("v_list.so?box=1");
	$("#jvForm").attr("action","v_tosend.so");
	$("#jvForm").submit();
}
function reply(){
	$("#nextUrl").val("v_list.so?box=1");
	$("#jvForm").attr("action","v_reply.so");
	$("#jvForm").submit();
}
function find_user(){
