...
public class FtpAct {
	...
	@RequestMapping("/ftp/v_add.so")
	public String add(ModelMap model) {
		return "ftp/add";
	}

	@RequiresPermissions("ftp:v_edit")
	@RequestMapping("/ftp/v_edit.so")
	...
	@RequestMapping("/ftp/o_update.so")
	...
	@RequestMapping("/ftp/o_delete.so")
