...
public abstract class BaseChannelCount  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.hcrcms.cms.entity.main.ChannelCount)) return false;
		else {
			com.hcrcms.cms.entity.main.ChannelCount channelCount = (com.hcrcms.cms.entity.main.ChannelCount) obj;
