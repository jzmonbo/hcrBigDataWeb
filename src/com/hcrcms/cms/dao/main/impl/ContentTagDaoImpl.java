...
import com.hcrcms.cms.dao.main.ContentTagDao;
...
public class ContentTagDaoImpl extends HibernateBaseDao<ContentTag, Integer>
	...
	public ContentTag findByName(String name, boolean cacheable) {
		...
		//Object obj = getSession().createQuery(hql).setParameter("name",name).setCacheable(cacheable).uniqueResult();
		//return (ContentTag) obj;
	}
