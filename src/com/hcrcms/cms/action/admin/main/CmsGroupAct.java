...
public class CmsGroupAct {
	...
	@RequestMapping("/group/v_list.so")
	...
	@RequestMapping("/group/v_edit.so")
	...
	@RequestMapping("/group/o_save.so")
	...
	@RequestMapping("/group/o_update.so")
	...
	@RequestMapping("/group/o_delete.so")
	...
	@RequestMapping("/group/o_priority.so")
	...
	@RequestMapping(value = "/group/v_channels_add.so")
	...
	@RequestMapping(value = "/group/v_channels_edit.so")
