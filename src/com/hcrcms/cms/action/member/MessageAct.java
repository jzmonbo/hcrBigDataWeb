...
import static com.hcrcms.cms.Constants.TPLDIR_MESSAGE;
...
import com.hcrcms.cms.manager.assist.CmsMessageMng;
...
public class MessageAct {
	...
	//自定义用户中心路径
	public static final String MESSAGE_CENTER = "/r/cms/www/default/member/message_center.html";
	 ...
	 * @return
	 */
	@RequestMapping(value = "/member/message_center.jspx")
	public String message_center(HttpServletRequest request, 
		...
		List<CmsReceiverMessage> receiverMessages = receiverMessageMng.getMyReceiverMessages(site,user);
		model.addAttribute("receiverMessages", receiverMessages);
	 ...
	 * @return
	 */
	@RequestMapping(value = "/member/read_message.jspx")
	public void read_message(Integer rmid,HttpServletRequest request, 
			HttpServletResponse response,ModelMap model) {
		CmsSite site = CmsUtils.getSite(request);
		CmsUser user = CmsUtils.getUser(request);
		receiverMessageMng.alreadyReadMessages(rmid);
		try {
