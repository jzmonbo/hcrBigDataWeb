...
import com.hcrcms.cms.manager.assist.CmsScoreGroupMng;
import com.hcrcms.cms.manager.assist.CmsScoreItemMng;
...
public class CmsScoreItemAct {
	...
	@RequestMapping("/scoreitem/v_list.so")
	...
	@RequestMapping("/scoreitem/v_add.so")
	...
	@RequestMapping("/scoreitem/v_edit.so")
	...
	@RequestMapping("/scoreitem/o_save.so")
	public String save(CmsScoreItem bean,Integer groupId, HttpServletRequest request, ModelMap model) {
		...
		return "redirect:v_list.so?groupId="+groupId;
	}

	@RequiresPermissions("scoreitem:o_update")
	@RequestMapping("/scoreitem/o_update.so")
	...
	@RequestMapping("/scoreitem/o_delete.so")
