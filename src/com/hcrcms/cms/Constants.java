...
public class Constants {
	 ...
	 * 模板路径(手机)
	 */
	public static final String TPL_MOBILE_BASE = "/WEB-INF/m/t/cms";
	/**
	 * 移动端模板路径
	 */
	public static final String M_TPL_BASE = "/WEB-INF/m/t/cms";
	/**
	 * 全文检索索引路径
	 */
	 ...
	 * 数据库备份文本前缀
	 */
	public static String ONESQL_PREFIX="HCRCMS_BACKUP_";
	/**
	 * 防火墙配置文件
	 */
	 ...
	 * 配置文件
	 */
	public static String HCRCMS_CONFIG = "/WEB-INF/config/hcr/hcrcms.properties";
	/**
	 * 插件路径
	 */
	 ...
	 * 模板路径
	 */
	public static final String TPL_BACK_BASE = "/WEB-INF/hcrcms_sys";
	
	/**
	 * 同步敏感詞用
	 */
	public static final String SENSITIVITY_STRING = "";
	
	/**
	 * 文章内容划词用
	 */
	public static final String CONTENT_WORDS = "";
}
