...
public abstract class BaseContentType  implements Serializable {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.hcrcms.cms.entity.main.ContentType)) return false;
		else {
			com.hcrcms.cms.entity.main.ContentType contentType = (com.hcrcms.cms.entity.main.ContentType) obj;
