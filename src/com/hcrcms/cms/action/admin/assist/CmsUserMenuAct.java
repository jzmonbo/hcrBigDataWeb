...
public class CmsUserMenuAct {
	...
	@RequestMapping("/menu/v_ajax_edit.so")
	...
	@RequestMapping("/menu/o_update.so")
	...
	@RequestMapping("/menu/o_delete.so")
