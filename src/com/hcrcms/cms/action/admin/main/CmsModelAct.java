...
public class CmsModelAct {
	...
	@RequestMapping("/model/v_list.so")
	...
	@RequestMapping("/model/v_add.so")
	public String add(ModelMap model) {
		return "model/add";
	}

	@RequiresPermissions("model:v_edit")
	@RequestMapping("/model/v_edit.so")
	...
	@RequestMapping("/model/o_save.so")
	...
	@RequestMapping("/model/o_update.so")
	...
	@RequestMapping("/model/o_delete.so")
	...
	@RequestMapping("/model/o_priority.so")
