...
public class PlugAct {
	...
	@RequestMapping(value = "/plug/v_list.so")
	...
	@RequestMapping("/plug/v_add.so")
	public String add(ModelMap model) {
		return "plug/add";
	}

	@RequiresPermissions("plug:v_edit")
	@RequestMapping("/plug/v_edit.so")
	...
	@RequestMapping("/plug/o_update.so")
	...
	@RequestMapping(value = "/plug/o_upload.so")
	...
	@RequestMapping(value = "/plug/o_install.so")
	...
	@RequestMapping("/plug/o_uninstall.so")
	...
	@RequestMapping("/plug/o_delete.so")
