...
<#macro selfDefineWidget
	type="1" id="" name="" label="" value="" help="" size="" rows="" cols="" list=""
...
<#elseif type=="5">
<@p.text colspan=colspan width=width label=label  name=name value=value readonly="readonly" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" class="Wdate" size=size?string help=help helpPosition=helpPosition/>
<#elseif type=="6">
<@p.select colspan=colspan width=width label=label id=id  name=name value=value help=help list=list!?split(",") helpPosition=helpPosition/>
<#elseif type=="7">
