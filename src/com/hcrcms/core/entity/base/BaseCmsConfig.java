...
public abstract class BaseCmsConfig  implements Serializable {
	...
	// components
	 com.hcrcms.core.entity.MarkConfig m_markConfig;
	 com.hcrcms.core.entity.EmailConfig m_emailConfig;
	...
	public com.hcrcms.core.entity.MarkConfig getMarkConfig () {
		return m_markConfig;
	}
	 ...
	 */
	public void setMarkConfig (com.hcrcms.core.entity.MarkConfig m_markConfig) {
		this.m_markConfig = m_markConfig;
	}


	public com.hcrcms.core.entity.EmailConfig getEmailConfig () {
	 ...
	 */
	public void setEmailConfig (com.hcrcms.core.entity.EmailConfig m_emailConfig) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.hcrcms.core.entity.CmsConfig)) return false;
		else {
			com.hcrcms.core.entity.CmsConfig cmsConfig = (com.hcrcms.core.entity.CmsConfig) obj;
