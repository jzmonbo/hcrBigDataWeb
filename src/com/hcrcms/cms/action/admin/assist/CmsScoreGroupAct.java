...
public class CmsScoreGroupAct {
	...
	@RequestMapping("/scoregroup/v_list.so")
	...
	@RequestMapping("/scoregroup/v_add.so")
	public String add(ModelMap model) {
		return "scoregroup/add";
	}

	@RequiresPermissions("scoregroup:v_edit")
	@RequestMapping("/scoregroup/v_edit.so")
	...
	@RequestMapping("/scoregroup/o_save.so")
	...
	@RequestMapping("/scoregroup/o_update.so")
	...
	@RequestMapping("/scoregroup/o_delete.so")
