...
import com.hcrcms.common.fck.Command;
import com.hcrcms.common.fck.ResourceType;
import com.hcrcms.common.fck.UploadResponse;
import com.hcrcms.common.fck.Utils;
...
import com.hcrcms.common.upload.UploadUtils;
...
public class FckAct {
	...
	// TODO 浏览服务器文件未实现
	// @RequestMapping(value = "/fck/connector.so")
	// public String connector() {
	// return null;
	// }

	@RequiresPermissions("fck:upload")
	@RequestMapping(value = "/fck/upload.so", method = RequestMethod.POST)
	public void upload(
