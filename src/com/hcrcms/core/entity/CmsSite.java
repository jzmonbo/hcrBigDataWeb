...
import static com.hcrcms.cms.Constants.LIBRARY_PATH;
import static com.hcrcms.cms.Constants.RES_PATH;
import static com.hcrcms.cms.Constants.TPLDIR_INDEX;
import static com.hcrcms.cms.Constants.TPL_BASE;
import static com.hcrcms.cms.Constants.TPL_MOBILE_BASE;
import static com.hcrcms.cms.Constants.TPL_SUFFIX;
import static com.hcrcms.cms.Constants.UPLOAD_PATH;
import static com.hcrcms.cms.Constants.M_TPL_BASE;
...
import com.hcrcms.core.entity.base.BaseCmsSite;
...
public class CmsSite extends BaseCmsSite {
	...
	public String getMobileTplIndexOrDef(){
		...
		t.append(M_TPL_BASE + "/" + getPath() + "/" + getTplSolution()).append("/");
		t.append(TPLDIR_INDEX).append("/").append(TPLDIR_INDEX);
		t.append(TPL_SUFFIX);
		return t.toString();
	}
	...
	public StringBuilder getUrlBuffer(boolean dynamic, Boolean whole,
		...
		if (!relative) {
			...
			int backPort = getPort();
			if (backPort != 80){
				url.append(":").append(backPort);
			}
		}
	...
	/**
	 * 获得模板方案（手机）路径。如：/WEB-INF/m/t/cms/www/default
	 * 
	 * @return
	 */
	public String getSolutionMobilePath() {
		return TPL_MOBILE_BASE + "/" + getPath() + "/" + getTplSolution();
	}
