...
public class CmsModelItemAct {
	...
	@RequestMapping("/item/o_priority.so")
	...
	@RequestMapping("/item/o_save_list.so")
	...
	@RequestMapping("/item/o_update.so")
	...
	@RequestMapping("/item/o_delete.so")
