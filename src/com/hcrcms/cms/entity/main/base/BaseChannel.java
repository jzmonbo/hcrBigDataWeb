...
public abstract class BaseChannel  implements Serializable {
	...
	public BaseChannel (
		...
		com.hcrcms.cms.entity.main.CmsModel model,
	...
	// one to one
	private com.hcrcms.cms.entity.main.ChannelExt channelExt;
	private com.hcrcms.cms.entity.main.ChannelCount channelCount;

	// many to one
	private com.hcrcms.core.entity.CmsSite site;
	private com.hcrcms.cms.entity.main.CmsModel model;
	private com.hcrcms.cms.entity.main.Channel parent;

	// collections
	private java.util.Set<com.hcrcms.cms.entity.main.Channel> child;
	private java.util.Set<com.hcrcms.core.entity.CmsGroup> viewGroups;
	private java.util.Set<com.hcrcms.core.entity.CmsGroup> contriGroups;
	private java.util.Set<com.hcrcms.core.entity.CmsUser> users;
	private java.util.Set<com.hcrcms.cms.entity.main.ChannelTxt> channelTxtSet;
	private java.util.List<com.hcrcms.cms.entity.main.ChannelModel> channelModels;
	 ...
	 */
	public com.hcrcms.cms.entity.main.ChannelExt getChannelExt () {
		return channelExt;
	}
	 ...
	 */
	public void setChannelExt (com.hcrcms.cms.entity.main.ChannelExt channelExt) {
		this.channelExt = channelExt;
	}
	
	public com.hcrcms.cms.entity.main.ChannelCount getChannelCount() {
		return channelCount;
	}

	public void setChannelCount(com.hcrcms.cms.entity.main.ChannelCount channelCount) {
	 ...
	 */
	public com.hcrcms.cms.entity.main.Channel getParent () {
		return parent;
	}
	 ...
	 */
	public void setParent (com.hcrcms.cms.entity.main.Channel parent) {
		this.parent = parent;
	}
	 ...
	 */
	public java.util.Set<com.hcrcms.cms.entity.main.Channel> getChild () {
		return child;
	}
	 ...
	 */
	public void setChild (java.util.Set<com.hcrcms.cms.entity.main.Channel> child) {
		this.child = child;
	}
	 ...
	 */
	public java.util.Set<com.hcrcms.core.entity.CmsGroup> getContriGroups () {
		return contriGroups;
	}
	 ...
	 */
	public void setContriGroups (java.util.Set<com.hcrcms.core.entity.CmsGroup> contriGroups) {
	 ...
	 */
	public java.util.Set<com.hcrcms.core.entity.CmsUser> getUsers () {
		return users;
	}
	 ...
	 */
	public void setUsers (java.util.Set<com.hcrcms.core.entity.CmsUser> users) {
		this.users = users;
	}
	/**
	 * Return the value associated with the column: channelTxtSet
	 */
	public java.util.Set<com.hcrcms.cms.entity.main.ChannelTxt> getChannelTxtSet () {
	 ...
	 */
	public void setChannelTxtSet (java.util.Set<com.hcrcms.cms.entity.main.ChannelTxt> channelTxtSet) {
		this.channelTxtSet = channelTxtSet;
	}

	public java.util.List<com.hcrcms.cms.entity.main.ChannelModel> getChannelModels() {
		return channelModels;
	}

	public void setChannelModels(
			java.util.List<com.hcrcms.cms.entity.main.ChannelModel> channelModels) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.hcrcms.cms.entity.main.Channel)) return false;
		else {
			com.hcrcms.cms.entity.main.Channel channel = (com.hcrcms.cms.entity.main.Channel) obj;
