...
import com.hcrcms.cms.entity.assist.CmsGuestbookCtg;
...
import com.hcrcms.cms.manager.assist.CmsAdvertisingMng;
import com.hcrcms.cms.manager.assist.CmsAdvertisingSpaceMng;
import com.hcrcms.cms.manager.assist.CmsDirectiveTplMng;
import com.hcrcms.cms.manager.assist.CmsFriendlinkCtgMng;
import com.hcrcms.cms.manager.assist.CmsGuestbookCtgMng;
import com.hcrcms.cms.manager.assist.CmsVoteTopicMng;
...
public class DirectiveAct {
	...
	@RequestMapping("/directive/module.so")
	...
	@RequestMapping("/directive/v_list.so")
	...
	@RequestMapping("/directive/v_add.so")
	public String add(HttpServletRequest request, ModelMap model) {
		return "directive/add";
	}
	
	@RequiresPermissions("directive:o_save")
	@RequestMapping("/directive/o_save.so")
	...
	@RequestMapping("/directive/v_getcode.so")
	...
	@RequestMapping("/directive/v_ajax_edit.so")
	...
	@RequestMapping("/directive/o_update.so")
	...
	@RequestMapping("/directive/o_delete.so")
