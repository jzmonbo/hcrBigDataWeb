...
public class LuceneDirectivePage extends LuceneDirectiveAbstract {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars,
		...
		//添加手机文章最大最小ID
		List<Content> lists = (List<Content>) page.getList();
		paramWrap.put("maxLengthId",DEFAULT_WRAPPER.wrap(lists.get(0).getId()));
		paramWrap.put("minLengthId",DEFAULT_WRAPPER.wrap(lists.get(lists.size()-1).getId()));
