...
public class CmsMessageAct {
	...
	@RequestMapping("/message/v_list.so")
	...
	@RequestMapping("/message/v_add.so")
	...
	@RequestMapping("/message/v_send.so")
	...
	@RequestMapping("/message/v_save.so")
	...
	@RequestMapping("/message/v_tosend.so")
	...
	@RequestMapping("/message/v_edit.so")
	...
	@RequestMapping("/message/o_update.so")
	...
	@RequestMapping("/message/v_read.so")
	...
	@RequestMapping("/message/v_forward.so")
	...
	@RequestMapping("/message/v_reply.so")
	...
	@RequestMapping("/message/v_trash.so")
	...
	@RequestMapping("/message/v_revert.so")
	...
	@RequestMapping("/message/v_empty.so")
	...
	@RequestMapping("/message/v_findUser.so")
	...
	@RequestMapping(value = "/message/v_countUnreadMsg.so")
