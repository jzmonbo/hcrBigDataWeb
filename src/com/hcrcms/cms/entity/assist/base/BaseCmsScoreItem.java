...
public abstract class BaseCmsScoreItem  implements Serializable {
	...
	public BaseCmsScoreItem (
		...
		com.hcrcms.cms.entity.assist.CmsScoreGroup group,
	...
	// many to one
	private com.hcrcms.cms.entity.assist.CmsScoreGroup group;

	// collections
	private java.util.Set<com.hcrcms.cms.entity.assist.CmsScoreRecord> records;
	 ...
	 */
	public com.hcrcms.cms.entity.assist.CmsScoreGroup getGroup () {
		return group;
	}
	 ...
	 */
	public void setGroup (com.hcrcms.cms.entity.assist.CmsScoreGroup group) {
		this.group = group;
	}
	 ...
	 */
	public java.util.Set<com.hcrcms.cms.entity.assist.CmsScoreRecord> getRecords () {
		return records;
	}
	 ...
	 */
	public void setRecords (java.util.Set<com.hcrcms.cms.entity.assist.CmsScoreRecord> records) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.hcrcms.cms.entity.assist.CmsScoreItem)) return false;
		else {
			com.hcrcms.cms.entity.assist.CmsScoreItem cmsScoreItem = (com.hcrcms.cms.entity.assist.CmsScoreItem) obj;
