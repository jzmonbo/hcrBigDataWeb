...
public abstract class BaseCmsSite  implements Serializable {
	...
	public BaseCmsSite (
		...
		com.hcrcms.core.entity.CmsConfig config,
	...
	// many to one
	private com.hcrcms.core.entity.Ftp uploadFtp;
	private com.hcrcms.core.entity.CmsConfig config;
	// one to one
	private com.hcrcms.core.entity.CmsSiteCompany siteCompany;
	 ...
	 */
	public com.hcrcms.core.entity.Ftp getUploadFtp () {
		return uploadFtp;
	}
	 ...
	 */
	public void setUploadFtp (com.hcrcms.core.entity.Ftp uploadFtp) {
	 ...
	 */
	public com.hcrcms.core.entity.CmsConfig getConfig () {
		return config;
	}
	 ...
	 */
	public void setConfig (com.hcrcms.core.entity.CmsConfig config) {
		this.config = config;
	}
	
	public com.hcrcms.core.entity.CmsSiteCompany getSiteCompany() {
		return siteCompany;
	}

	public void setSiteCompany(com.hcrcms.core.entity.CmsSiteCompany siteCompany) {
	...
	public void setUserSites(
			java.util.Set<com.hcrcms.core.entity.CmsUserSite> userSites) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.hcrcms.core.entity.CmsSite)) return false;
		else {
			com.hcrcms.core.entity.CmsSite cmsSite = (com.hcrcms.core.entity.CmsSite) obj;
