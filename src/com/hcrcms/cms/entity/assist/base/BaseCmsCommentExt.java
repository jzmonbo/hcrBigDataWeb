...
public abstract class BaseCmsCommentExt  implements Serializable {
	...
	private java.lang.String anonymousName;						//匿名用户名称
	private java.lang.String anonymousImg;						//匿名用户头像
	private java.lang.Integer sort;								//回复排序序号
	private java.lang.Integer rsort;							//回复列表排序序号
	private java.util.Date replayTime;							//回复时间

	// many to one
	private com.hcrcms.cms.entity.assist.CmsComment comment;
	 ...
	 */
	public com.hcrcms.cms.entity.assist.CmsComment getComment () {
		return comment;
	}
	 ...
	 */
	public void setComment (com.hcrcms.cms.entity.assist.CmsComment comment) {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.hcrcms.cms.entity.assist.CmsCommentExt)) return false;
		else {
			com.hcrcms.cms.entity.assist.CmsCommentExt cmsCommentExt = (com.hcrcms.cms.entity.assist.CmsCommentExt) obj;
	...
	@OrderBy("rsort desc")
	public java.lang.Integer getRsort() {
		return rsort;
	}

	public void setRsort(java.lang.Integer rsort) {
		this.rsort = rsort;
	}
