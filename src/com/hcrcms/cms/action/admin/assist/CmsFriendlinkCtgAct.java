...
public class CmsFriendlinkCtgAct {
	...
	@RequestMapping("/friendlink_ctg/v_list.so")
	...
	@RequestMapping("/friendlink_ctg/o_save.so")
	...
	@RequestMapping("/friendlink_ctg/o_update.so")
	...
	@RequestMapping("/friendlink_ctg/o_delete.so")
