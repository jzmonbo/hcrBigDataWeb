...
public class UnifiedUserAct {
	...
	@RequestMapping("/unified_user/v_list.so")
	...
	@RequiresPermissions("unified_user:v_list")
	@RequestMapping("/unified_user/v_add.so")
	public String add(ModelMap model) {
		return "unified_user/add";
	}

	@RequiresPermissions("unified_user:v_edit")
	@RequestMapping("/unified_user/v_edit.so")
	...
	@RequestMapping("/unified_user/o_save.so")
	...
	@RequestMapping("/unified_user/o_update.so")
	...
	@RequestMapping("/unified_user/o_delete.so")
	...
	@RequestMapping("/unified_user/v_check_username.so")
	...
	@RequestMapping("/unified_user/v_check_email.so")
